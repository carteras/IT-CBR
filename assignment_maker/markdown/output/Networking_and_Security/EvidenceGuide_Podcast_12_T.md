...
![Achievement Standards](assets/NS_12_T.png)
...
<table style="border: 1px solid black;">
    ...
    <tr valign='middle'>
        ...
        <td>
        <p>
            You have submitted evidence of completing the a podcast or your negotiated subject. 
            This evidence is submitted in an appropriate format unless negotiated 
            for a different format.
        </p>
        <p>
            The evidence of podcast appears to be of appropriate level for your accreditation level and the topic chosen.
        </p>
        <p>
            <ul>
                <li>An introduction to the subject matter</li>
                <li>A summary of what the topic is about: including placing it the historic timeline</li>
                <li>Information regardin the topics of technology or industry</li>
            </ul>
        </p>
        <p>
            <ul>
                <li>An annotated Bibliography that represents your research. This should have multiple resources. There is no hard minimum limit but you should have multiple supporting pieces of evidence.</li>
                <li>A script where major claims are linked to the bibliography</li>
                <li>An audio or video podcast piece that goes for no less than 5 minutes and no more than 10 minutes</li>
            </ul>
        </p>
        <p>
