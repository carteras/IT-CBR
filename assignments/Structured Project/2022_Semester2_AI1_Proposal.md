...
-   A description intended audience and use

-   If your project is interactable in digital or physical space you
    must include sketches.
...
-   Lightweight process diagramming (boxes and arrows) of how the key
    parts of your project will work.
...
on time and resaources. Resources may be able to be acquired but due to
covid/global-shortages/etc., this is not depentable. Time is limited, as
semester finishes early and we have 3 hours 40 minutes each week.

The default example for this project is:
...
-   A description of the intendence audience and use
...
<li><p>A decription of who will use your product and how it will be used or why your system exists and how it works.</p></li>
</ul>
...
<p>(individual)</p></td>
<td><p>Task description</p>
<p>Story cards which abstract the major parts of your project onto index cards (or something similar)</p>
<ul>
<li><p>Project Story Cards which provides a high level overview of your system</p></li>
...
<ul>
<li><p>your understanding of technology concepts and principles</p></li>
